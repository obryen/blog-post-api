...
func (server *Server) CreatePost(w http.ResponseWriter, r *http.Request) {
	...
	responses.ToJsonResponse(w, http.StatusCreated, postCreated)
}
...
func (server *Server) GetPosts(w http.ResponseWriter, r *http.Request) {
	...
	responses.ToJsonResponse(w, http.StatusOK, posts)
}
...
func (server *Server) GetPost(w http.ResponseWriter, r *http.Request) {
	...
	postReceived, err := post.FindOnePost(server.DB, pid)
	if err != nil {
		responses.ToError(w, http.StatusInternalServerError, err)
		return
	}
	responses.ToJsonResponse(w, http.StatusOK, postReceived)
}
...
func (server *Server) UpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		responses.ToError(w, http.StatusNotFound, errors.New("Post not found"))
		return
	}
	...
	responses.ToJsonResponse(w, http.StatusOK, postUpdated)
}
...
func (server *Server) DeletePost(w http.ResponseWriter, r *http.Request) {
	...
	err = server.DB.Debug().Model(models.Post{}).Where("id = ?", pid).Take(&post).Error
	if err != nil {
		responses.ToError(w, http.StatusNotFound, errors.New("Unauthorized"))
		return
	}
